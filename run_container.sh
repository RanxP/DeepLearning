...
torchrun --nnodes=1 --nproc_per_node=1 train.py --data_path "/gpfs/work5/0/jhstue005/JHS_data/CityScapes" --cloud_exec --figure_size 10 --batch_size 2 --workers 14 --number_of_epochs 20